...
def enviar_email(request, pk):
    ...
    send_mail(
        'Nova Senha em TW314',
        'Olá, ' + usuario['nome'] + '! Para continuar e acessar sua conta no sistema TW314, acesso o link http://localhost:8000' + str(reverse('adiciona_senha', args=[str(usuario['id'])])) + ' e cadastre sua nova senha. Se acredita que houve um engano, por favor, entre em contado pelo e-mail contato@tw314.com.br. Att, Time TW314',
